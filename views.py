...
from .models import Drawing, AgeGroup, Subject, Course, Lesson, Story, LessonCompletion
...
def teacher_dashboard(request):
    ...
    if not hasattr(request.user, 'userprofile') or request.user.userprofile.user_type != 'teacher':
        return render(request, 'kids/not_authorized.html')
...
def lesson_detail(request, lesson_id):
    ...
    if lesson.lesson_type == 'alphabet':
        ...
        alphabet_images = {
            # ...removed movie image URLs...
            # ...removed more movie image URLs...
        }
        ...
        phonics_images = {
            # ...removed local movie image URLs...
        }
        for letter in 'FGHIJKLMNOPQRSTUVWXYZ':
            # ...removed phonics movie image...
